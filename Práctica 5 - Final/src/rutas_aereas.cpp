...
//./main.exe paises.txt imagenes/mapas/mapa1.ppm imagenes/banderas/ almacen_rutas.txt imagenes/aviones/avion4.ppm imagenes/aviones/mascara_avion4.pgm
...
int main(int argc, char * argv[]){
  ...
  Paises::const_iterator ip_before =Pses.end();
  Paises::const_iterator ip=Pses.end();
  Imagen i_ban_inicio;
